...
export const MultiCitySearchPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-primary-950 to-primary-950 text-white py-8">
        <div className="container mx-auto px-4">
          <button
            onClick={handleBackToSearch}
            className="flex items-center space-x-2 text-white hover:text-accent-100 mb-4 transition-colors"
          >
          ...
          <div className="lg:col-span-1">
            <div className="lg:sticky lg:top-4">
              ...
              <div className="mt-6 bg-accent-50 rounded-lg p-4 border border-accent-200">
                <h3 className="font-semibold text-primary-950 mb-2">💡 Pro Tips</h3>
                <ul className="text-sm text-primary-950 space-y-2">
          ...
          <div id="results-section" className="lg:col-span-2">
                      ...
                      {searchResults.segments.map((segment: any, index: number) => (
                        <React.Fragment key={index}>
                          <div className="flex items-center space-x-1 flex-shrink-0">
                            <span className="px-3 py-1 bg-accent-100 text-primary-950 rounded-lg text-sm font-medium">
                              {segment.origin}
                            </span>
            ...
            {!isSearching && !searchResults && (
              <div className="bg-white rounded-lg shadow-lg p-12 text-center">
                <div className="w-24 h-24 mx-auto mb-6 bg-accent-100 rounded-full flex items-center justify-center">
                  <Plane className="w-12 h-12 text-primary-950" />
                </div>
