        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-gray-800 p-2.5 rounded-lg hover:bg-accent-500 transition-all duration-300 hover:scale-110">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:support@peakpasstravel.com" className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm text-center md:text-left">
              <p>&copy; {currentYear} Peakpass Travel. All rights reserved.</p>
            </div>
          ...
          <div className="mt-4 text-center text-xs text-gray-500">
            <p>Powered by Amadeus GDS | Peakpass Travel - Your Journey Partner</p>
          </div>
        </div>
      </div>
    </footer>
